...
public class Base extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Instrument instrument = new Instrument(
                getConfigString("db.ip"), getConfigString("db.port"), getConfigString("db.database"),
                getConfigString("db.user"), getConfigString("db.password"), getConfigString("db.url"),
                getConfigString("db.driver"), null, true, 1
        );
        ...
        musician = new Musician(director, instrument, 200);
